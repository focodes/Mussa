...
.categoriax label::before {
    ...
    height: 20px;
    margin-right: 8px;
    background-color: #007bff; /* Cambia el color de fondo del radio button */
    border-radius: 50%;
    border: 2px solid #007bff; /* Cambia el color del borde del radio button */
    position: relative;
    top: 5px;
}

.categoriax input[type="radio"]:checked + label::before {
    background-color: #28a745; /* Cambia el color de fondo cuando está seleccionado */
    border-color: #28a745; /* Cambia el color del borde cuando está seleccionado */
}
...
.drop-container {
    border: 2px dashed #007bff; /* Cambia el color del borde del área de carga */
    padding: 20px;
    cursor: pointer;
}
...
.drop-title {
    font-weight: bold;
    color: #007bff; /* Cambia el color del título del área de carga */
}
...
.file-input:not(:disabled):valid + .file-name::after {
    ...
    color: #28a745; /* Cambia el color del nombre del archivo cuando está seleccionado */
}
...
<main class="formularios">
        ...
        <div class="categoria">
            <div class="title-categorias">
                ...
                <div class="descargar-formato">
                    ...
                    <button class="btn btn-warning" id="descargar" onclick="descargarArchivoPonente()">Descargar <i class="fa-solid fa-download"></i></button>
                </div>
            </div>
                ...
                <form action="includes/config/registrarPonentes.php" method="POST" class="form" id="form-ponente" enctype="multipart/form-data">
                    <fieldset>
                        ...
                        <div class="form-group">
                            ...
                            <select id="ejetematico" class="form-control" onchange="mostrar()" name="ejetematico">
                        ...
                        <div class="form-group">
                            ...
                            <select id="Institucion" class="form-control" onchange="mostrar()" name="tipoInstitucion">
                                <option value="">Seleccione una opción</option>
                        ...
                        <div class="mostrar-input-externa">
                            <div class="form-group">
                                ...
                                <input type="text" placeholder="Nombre de la institución..." name="externa" class="form-control" id="externa">
                            </div>
                        </div>
                        <div class="mostrar-input-sena">
                            <div class="form-group">
                                <label for="titulada" class="text">Titulada:</label>
                                <input type="text" placeholder="Nombre de la titulada.." name="titulada" class="form-control" id="titulada">
                            </div>
                            <div class="form-group">
                                <label for="ficha" class="text">Ficha:</label>
                                <input type="text" placeholder="# de ficha..." name="ficha" class="form-control" id="ficha" pattern="[0-9]{4,20}">
                            </div>
                        </div>
                        <div class="form-group">
                            <label for="Ponentes" class="text">Número de ponentes:</label>
                            <select id="Ponentes" name="numeroPonentes" class="form-control" onchange="crearCampos()">
                                <option value="">Seleccione una opción</option>
    ...
    <p class="form-title">Se debe cargar documento en formato Word con la información del proyecto y documento en PowerPoint o PDF con la presentación del proyecto. (Limite de tamaño: 20 MB por documento).</p>
    <label for="archivo_1" class="drop-container">
        <span class="drop-title">Selecciona tus archivos PDF o PowerPoint aquí:</span>
        <input type="file" name="archivo_1" accept=".pdf,.pptx" id="archivo_1" class="file-input">
    ...
    <label for="archivo_2" class="drop-container">
        ...
        <input type="file" name="archivo_2" accept=".docx" id="archivo_2" class="file-input">
        <span class="file-name">Ningún archivo seleccionado</span>
    </label>
</div>

                    </fieldset>
                    <button class="btn btn-success" type="submit" value="Registrarme" class="button-registro">Registrarme</button>
                </form>
            </div>
        </div>
    </section>
        ...
        <div class="categoria">
            <div class="title-categorias">
                ...
                <div class="descargar-formato">
                    ...
                    <button class="btn btn-warning" id="descargar" onclick="descargarArchivoPoster()">Descargar <i class="fa-solid fa-download"></i></button>
                </div>
            </div>
            <div class="formulario">
                <form action="../../includes/config/registrarPoster.php" method="POST" id="form-poster" class="form" enctype="multipart/form-data">
                    <fieldset>
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" placeholder="Nombre de la Institución" name="nombreInstitucion" class="form-control" id="nombreInstitucion">
                        </div>
                        <div class="form-group">
                            <label for="participantes" class="text">Participantes:</label>
                            <select id="participantes" name="participantes" class="form-control" onchange="crearCampos()">
                                <option value="">Seleccione una opción</option>
                                <option value="1">1</option>
                                <option value="2">2</option>
                                <option value="3">3</option>
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" placeholder="..." name="tituloProyecto" class="form-control" id="tituloProyecto">
                        </div>
                        <div class="form-group files">
                            <p class="form-title">Se debe cargar la presentación o diseño del poster en PDF. (Tamaño máximo del documento 20Mb)</p>
