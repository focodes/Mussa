                ...
                <div class="container mt-5">
                    ...
                    <form>
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control" id="nombreSitio"
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control" id="redesSociales"
                                placeholder="Ingrese las redes sociales">
                        </div>
                        <div class="form-group">
                            <label for="redesSociales1">Redes Twiter:</label>
                            <input type="text" class="form-control" id="redesSociales1"
                                placeholder="Ingrese las redes sociales">
                        </div>
                        <div class="form-group">
                            <label for="redesSociales2">Redes Instagram:</label>
                            <input type="text" class="form-control" id="redesSociales2"
                                placeholder="Ingrese las redes sociales">
                        </div>
                        <div class="form-group">
